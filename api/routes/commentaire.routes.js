...
module.exports = function (app, Joi, validator) {
  ...
  app.post(
    "/comments",
    [AuthJwt.verifyToken],
    validator.body(comSchema),
    handlers.createCommentaire
  );
  app.patch(
    "/comment/:id",
    [AuthJwt.verifyToken, AuthJwt.isAuthorize],
    validator.params(queryStringCom),
  ...
  app.delete(
    ...
    [AuthJwt.verifyToken, AuthJwt.isAuthorize],
    validator.params(queryStringCom),
    handlers.deleteCommentaire
  );
  app.get(
    "/comments/:id",
    [AuthJwt.verifyToken],
    validator.params(paramsStringCom),
    validator.query(queryStringCom),
    handlers.showCommentaires
  );
